...
const LOCAL_CATEGORIES = [
  { title: "Purchasing", icon: ShoppingCart, reports: ["Spending by Supplier", "Monthly Purchase Totals", "Quarterly Spending", "Open Orders", Approvals", "Purchase History by Item"] },
