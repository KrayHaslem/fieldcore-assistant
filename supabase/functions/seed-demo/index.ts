...
serve(async (req) => {
  ...
  try {
    ...
    const action = body.action ?? "reset"; // "reset" | "clear"
    ...
    const poData = [
      ...
      { id: PO(13), po_number: "ord-2025-H01", supplier_id: SUP.hydro, department_id: DEPT.manufacturing, status: "closed", total_amount: 8985, created_by: sarah, created_at: "2025-06-10T09:00:00Z", approved_by: sarah, approved_at: "2025-06-10T10:00:00Z", ordered_at: "2025-06-11T08:00:00Z", received_at: "2025-06-18T14:00:00Z", notes: "Initial valve and o-ring stock" },
      { id: PO(14), po_number: "ord-2025-H02", supplier_id: SUP.premier, department_id: DEPT.manufacturing, status: "closed", total_amount: 7120, created_by: sarah, created_at: "2025-06-12T10:00:00Z", approved_by: sarah, approved_at: "2025-06-12T11:00:00Z", ordered_at: "2025-06-13T08:00:00Z", received_at: "2025-07-04T14:00:00Z", notes: "Safety valve opening stock" },
      { id: PO(15), po_number: "ord-2025-H03", supplier_id: SUP.simper, department_id: DEPT.manufacturing, status: "closed", total_amount: 9975, created_by: james, created_at: "2025-06-15T08:00:00Z", approved_by: sarah, approved_at: "2025-06-15T14:00:00Z", ordered_at: "2025-06-16T08:00:00Z", received_at: "2025-06-26T10:00:00Z", notes: "Pump components for initial assembly runs" },
      { id: PO(16), po_number: "ord-2025-H04", supplier_id: SUP.safety, department_id: DEPT.manufacturing, status: "closed", total_amount: 1775, created_by: maria, created_at: "2025-07-01T08:00:00Z", approved_by: sarah, approved_at: "2025-07-01T09:00:00Z", ordered_at: "2025-07-01T10:00:00Z", received_at: "2025-07-04T10:00:00Z", notes: "Initial safety supplies stock" },
      { id: PO(17), po_number: "ord-2025-H05", supplier_id: SUP.breakroom, department_id: DEPT.office, status: "closed", total_amount: 520, created_by: sarah, created_at: "2025-07-05T09:00:00Z", approved_by: sarah, approved_at: "2025-07-05T09:30:00Z", ordered_at: "2025-07-05T10:00:00Z", received_at: "2025-07-08T11:00:00Z", notes: "Breakroom supplies setup" },
      { id: PO(18), po_number: "ord-2025-H06", supplier_id: SUP.office, department_id: DEPT.office, status: "closed", total_amount: 420, created_by: sarah, created_at: "2025-07-05T09:00:00Z", approved_by: sarah, approved_at: "2025-07-05T09:30:00Z", ordered_at: "2025-07-05T10:00:00Z", received_at: "2025-07-08T11:00:00Z", notes: "Office supplies setup" },
      { id: PO(19), po_number: "ord-2025-H07", supplier_id: SUP.logan, department_id: DEPT.maintenance, status: "closed", total_amount: 2376, created_by: james, created_at: "2025-07-10T08:00:00Z", approved_by: sarah, approved_at: "2025-07-10T14:00:00Z", ordered_at: "2025-07-11T08:00:00Z", received_at: "2025-07-16T10:00:00Z", notes: "Fleet maintenance supplies — initial stock" },
      // Active POs
      { id: PO(1), po_number: "ord-2025-001", supplier_id: SUP.logan, department_id: DEPT.manufacturing, status: "closed", total_amount: 690, created_by: james, created_at: "2025-10-05T10:00:00Z", notes: "MIG wire and weld rod restock" },
      { id: PO(2), po_number: "ord-2025-002", supplier_id: SUP.swsteel, department_id: DEPT.manufacturing, status: "received", total_amount: 4350, created_by: james, created_at: "2025-10-18T14:00:00Z", notes: "Steel plates for Q1 production" },
      { id: PO(3), po_number: "ord-2025-003", supplier_id: SUP.simper, department_id: DEPT.manufacturing, status: "approved", total_amount: 6650, created_by: sarah, created_at: "2025-11-02T09:00:00Z", notes: "Pump components for March builds" },
      { id: PO(4), po_number: "ord-2025-004", supplier_id: SUP.hydro, department_id: DEPT.maintenance, status: "ordered", total_amount: 334, created_by: maria, created_at: "2025-11-15T11:00:00Z", notes: "Hydraulic fittings and fluid for trucks" },
      { id: PO(5), po_number: "ord-2025-005", supplier_id: SUP.safety, department_id: DEPT.manufacturing, status: "submitted", total_amount: 680, created_by: maria, created_at: "2025-12-01T08:00:00Z", notes: "Quarterly safety supplies" },
      { id: PO(6), po_number: "ord-2025-006", supplier_id: SUP.logan, department_id: DEPT.manufacturing, status: "draft", total_amount: 530, created_by: james, created_at: "2025-12-10T15:00:00Z", notes: "O-rings and seal kits draft" },
      { id: PO(7), po_number: "ord-2025-007", supplier_id: SUP.premier, department_id: DEPT.manufacturing, status: "closed", total_amount: 9000, created_by: sarah, created_at: "2026-01-08T10:00:00Z", notes: "Triplex pump assemblies for resale" },
      { id: PO(8), po_number: "ord-2025-008", supplier_id: SUP.swsteel, department_id: DEPT.manufacturing, status: "received", total_amount: 2900, created_by: james, created_at: "2026-01-20T13:00:00Z", notes: "Additional steel plates" },
      { id: PO(9), po_number: "ord-2025-009", supplier_id: SUP.office, department_id: DEPT.office, status: "ordered", total_amount: 252, created_by: sarah, created_at: "2026-02-03T09:00:00Z", notes: "Office supplies" },
      { id: PO(10), po_number: "ord-2025-010", supplier_id: SUP.logan, department_id: DEPT.manufacturing, status: "submitted", total_amount: 570, created_by: maria, created_at: "2026-02-15T10:00:00Z", notes: "Weld rod and MIG wire" },
      { id: PO(11), po_number: "ord-2025-011", supplier_id: SUP.hydro, department_id: DEPT.maintenance, status: "closed", total_amount: 190, created_by: james, created_at: "2026-02-25T14:00:00Z", notes: "Hydraulic fittings for crane" },
      { id: PO(12), po_number: "ord-2025-012", supplier_id: SUP.simper, department_id: DEPT.manufacturing, status: "approved", total_amount: 5300, created_by: sarah, created_at: "2026-03-01T08:00:00Z", notes: "Pump components for Q2 production" },
    ];
